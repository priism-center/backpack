...
data_raw <- backpack::birthwt
birthweight <- data_raw
...
```{r gen_lbw, exercise=TRUE, exercise.setup = 'load-data'}
...
```{r odds_ratio-compare, exercise = TRUE, exercise.setup = 'prepare-data-2'}
...
```{r fit_logit_3, exercise=TRUE, exercise.setup = 'prepare-data-2'}
...
```{r fit_probit, exercise = TRUE, exercise.setup = 'prepare-data-2'}
...
```{r fit_cloglog, exercise = TRUE, exercise.setup = 'prepare-data-2'}
...
```{r interaction, exercise=TRUE, exercise.setup = 'prepare-data-2'}
